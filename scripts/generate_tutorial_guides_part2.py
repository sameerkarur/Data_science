...
# =====================================================================
# 3. Matplotlib Master Guide
# =====================================================================
MATPLOTLIB_MASTER_GUIDE = r'''# Matplotlib: Complete Step-by-Step Tutorial & Data Visualization Guide
...
# Write to Matplotlib paths
p_mp1 = REPO_ROOT / "02_IITK_AIML_Core_Applied_Data_Science_with_Python/10_data_visualization/matplotlib/matplotlib_basics.md"
p_mp2 = REPO_ROOT / "02_IITK_AIML_Core_Applied_Data_Science_with_Python/10_data_visualization/matplotlib/basics.md"
p_mp3 = REPO_ROOT / "02_IITK_AIML_Core_Applied_Data_Science_with_Python/10_data_visualization/basics.md"

p_mp1.write_text(MATPLOTLIB_MASTER_GUIDE.strip() + "\n", encoding="utf-8")
p_mp2.write_text(MATPLOTLIB_MASTER_GUIDE.strip() + "\n", encoding="utf-8")
p_mp3.write_text(MATPLOTLIB_MASTER_GUIDE.strip() + "\n", encoding="utf-8")
print(f"✅ Generated Matplotlib Master Guide: {len(MATPLOTLIB_MASTER_GUIDE.splitlines())} lines.")

# =====================================================================
# 4. Seaborn Master Guide
# =====================================================================
SEABORN_MASTER_GUIDE = r'''# Seaborn: Complete Step-by-Step Statistical Graphics Handbook
**Official Tutorial & Visual Architecture Handbook (W3Schools & GeeksforGeeks Style)**
...
p_sb1 = REPO_ROOT / "02_IITK_AIML_Core_Applied_Data_Science_with_Python/10_data_visualization/seaborn/seaborn_basics.md"
p_sb2 = REPO_ROOT / "02_IITK_AIML_Core_Applied_Data_Science_with_Python/10_data_visualization/seaborn/basics.md"

p_sb1.write_text(SEABORN_MASTER_GUIDE.strip() + "\n", encoding="utf-8")
p_sb2.write_text(SEABORN_MASTER_GUIDE.strip() + "\n", encoding="utf-8")
print(f"✅ Generated Seaborn Master Guide: {len(SEABORN_MASTER_GUIDE.splitlines())} lines.")
