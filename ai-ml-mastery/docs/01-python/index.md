...
- [x] [Fundamentals, Control Flow & Collections — full deep-dive](fundamentals-control-flow-collections-deep-dive.md)
...
- [x] [OOP — full deep-dive (classes, inheritance, magic methods, dataclasses, MRO)](oop-deep-dive.md)

## Part F — Advanced Python

- [x] [Advanced Python — full deep-dive (iterators, generators, comprehensions, context managers, exceptions, modules, type hints, async, concurrency & the GIL)](advanced-python-deep-dive.md)
