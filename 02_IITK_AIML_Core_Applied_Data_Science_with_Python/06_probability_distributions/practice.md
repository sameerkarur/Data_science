# Probability Distributions — Practice Questions (50+)
...
**Q1.** Define Probability and give AIML example.

**Q2.** Load AusApparalSales4thQrt2020.csv and describe `Sales`.

**Q3.** Compute mean, median, std of `Sales`.

**Q4.** Explain when to use Probability test vs alternative.

**Q5.** Simulate 1000 draws from normal; plot histogram.

**Q6.** Calculate 95% CI for mean of `Sales`.

**Q7.** State null and alternative hypothesis for Probability.

**Q8.** What alpha=0.05 means in Probability.

**Q9.** Type I vs Type II error in Probability.
...
**Q11.** Define Probability and give AIML example.

**Q12.** Load AusApparalSales4thQrt2020.csv and describe `Sales`.

**Q13.** Compute mean, median, std of `Sales`.

**Q14.** Explain when to use Probability test vs alternative.

**Q15.** Simulate 1000 draws from normal; plot histogram.

**Q16.** Calculate 95% CI for mean of `Sales`.

**Q17.** State null and alternative hypothesis for Probability.

**Q18.** What alpha=0.05 means in Probability.

**Q19.** Type I vs Type II error in Probability.
...
**Q21.** Define Probability and give AIML example.

**Q22.** Load AusApparalSales4thQrt2020.csv and describe `Sales`.

**Q23.** Compute mean, median, std of `Sales`.

**Q24.** Explain when to use Probability test vs alternative.

**Q25.** Simulate 1000 draws from normal; plot histogram.

**Q26.** Calculate 95% CI for mean of `Sales`.

**Q27.** State null and alternative hypothesis for Probability.

**Q28.** What alpha=0.05 means in Probability.

**Q29.** Type I vs Type II error in Probability.
...
**Q31.** Define Probability and give AIML example.

**Q32.** Load AusApparalSales4thQrt2020.csv and describe `Sales`.

**Q33.** Compute mean, median, std of `Sales`.

**Q34.** Explain when to use Probability test vs alternative.

**Q35.** Simulate 1000 draws from normal; plot histogram.

**Q36.** Calculate 95% CI for mean of `Sales`.

**Q37.** State null and alternative hypothesis for Probability.

**Q38.** What alpha=0.05 means in Probability.

**Q39.** Type I vs Type II error in Probability.
...
**Q41.** Define Probability and give AIML example.

**Q42.** Load AusApparalSales4thQrt2020.csv and describe `Sales`.

**Q43.** Compute mean, median, std of `Sales`.

**Q44.** Explain when to use Probability test vs alternative.

**Q45.** Simulate 1000 draws from normal; plot histogram.

**Q46.** Calculate 95% CI for mean of `Sales`.

**Q47.** State null and alternative hypothesis for Probability.

**Q48.** What alpha=0.05 means in Probability.

**Q49.** Type I vs Type II error in Probability.
